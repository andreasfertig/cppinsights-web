...
def getSupportedOptions():
    opts = [ {'desc': 'C++ Standard'             , 'flag' : '',                         'name' : 'C++ Standard',              'selected' : False, 'label' : True,  'single' : False , 'ccopt' : False, 'cppStd' : False },
             ...
             {'desc': 'cpp23'                    , 'flag' : '-std=c++23',               'name' : 'C++ 23',                    'selected' : False, 'label' : False, 'single' : True  , 'ccopt' : True,  'cppStd' : True  },
             {'desc': 'cpp2c'                    , 'flag' : '-std=c++2c',               'name' : 'C++ 2c',                    'selected' : False, 'label' : False, 'single' : True  , 'ccopt' : True,  'cppStd' : True  },
